...
<html>
    ...
    <body>
        ...
        <header class="bg-primary text-white py-5 text-center">
            <div class="container">
                <h1 class="display-4">Showcase Your Creativity</h1>
        ...
        <section class="popular-shots py-5">
            <div class="container">
                <h2 class="fw-bold text-center mb-4">Popular Projects</h2>
                <div class="row row-cols-1 row-cols-md-3 g-4">
                    <div class="col">
                        <div class="card border-0 shadow-sm">
                            <img src="dribble 1.webp" class="card-img-top" alt="Creative Design">
                    ...
                    <div class="col">
                        <div class="card border-0 shadow-sm">
                            <img src="dribble 2.webp" class="card-img-top" alt="Unique Concepts">
                            <div class="card-body text-center">
                    ...
                    <div class="col">
                        <div class="card border-0 shadow-sm">
                            <img src="dribble 3.webp" class="card-img-top" alt="Innovative Ideas">
                            <div class="card-body text-center">
